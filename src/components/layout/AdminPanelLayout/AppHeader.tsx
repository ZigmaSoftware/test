            ...
            <form>
              <div className="relative">
                ...
                <input
                  ...
                  className="h-11 w-full rounded-full border border-gray-200 bg-gray-50 py-2.5 pl-12 pr-16 text-sm text-gray-700 shadow-sm placeholder:text-gray-400 focus:border-[#9cc6ff] focus:ring-2 focus:ring-[#cfe4ff] xl:w-[430px]"
                />

                <div className="absolute right-3 top-1/2 inline-flex -translate-y-1/2 items-center gap-1 rounded-full border border-gray-200 bg-white px-3 py-1 text-xs font-medium text-gray-500 shadow-sm">
                  <span>⌘</span>
                  <span>K</span>
                </div>
              </div>
